...
// CODE HERE
const totalPopulatiom = populations.reduce((total, curr) => total + curr)
// console.log(totalPopulatiom)
...
let bobsTotal = purchases.filter((order) => order.owner === "Bob").reduce((total, curr) => total + curr.price, 0)
